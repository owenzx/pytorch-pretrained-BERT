...
export COREF_UNL_DATA_PATH=/fortest/xzh/datasets/unlabeled_news/cnn.tokenized.json
...
allennlp train scripts/lasy/lasy_joint_ssl_1.jsonnet -s outputs/lasy_joint_ssl_1106_1 --include-package allen_packages
