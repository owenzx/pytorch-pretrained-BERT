...
allennlp train scripts/allen/coref_bert_cased_tune_large_train10.jsonnet -s outputs/mentionswitch_really_baseline_train10_1108_3 --include-package allen_packages
