...
allennlp train scripts/mention_switch/dgx_1_mentionswitch_consist_same.jsonnet -s outputs/dgx_1_lc10_mentionswitch_consist_same_0912 --include-package allen_packages
