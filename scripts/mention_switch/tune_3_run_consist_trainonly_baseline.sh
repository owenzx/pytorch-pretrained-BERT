...
allennlp train scripts/mention_switch/tune_3_mentionswitch_consist_same.jsonnet -s outputs/tune_3_mentionswitch_consist_same_1025_1 --include-package allen_packages
