...
allennlp train scripts/mention_switch/tune_mentionswitch_detect_consist_same.jsonnet -s outputs/tune_mentionswitch_detect_consist_same_1026 --include-package allen_packages
