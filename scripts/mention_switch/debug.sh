...
export COREF_UNL_DATA_PATH=/playpen/home/xzh/datasets/coref/allen/test.english.v4_gold_conll

allennlp train scripts/allen/coref_bert_debug.jsonnet -s outputs/debug_0913 --include-package allen_packages
