...
allennlp evaluate --cuda-device 0 --overrides='{"dataset_reader":{"cached_instance_path":"./cache/conll_dev_gt_add_clause.ist"}}' --include-package allen_packages --output-file ./outputs/test_bert_sw_dev_clause.out ./outputs/mentionswitch_really_baseline_0910 /playpen/home/xzh/datasets/coref/allen/dev.english.v4_gold_conll
