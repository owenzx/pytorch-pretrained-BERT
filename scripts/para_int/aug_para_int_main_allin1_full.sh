...
do
    python run_classifier_adv.py \
      ...
      --max_seq_length 128 \
      --real_path "./outputs/aug_para_int_"$i"_all/subsampled_0.1.pkl.augstr_para_int_basic.augnum3.pkl" \
      --output_dir "./outputs/aug_para_int_main_"$i"_all/" > "./outputs/aug_para_int_main_"$i"_all.out"
done
