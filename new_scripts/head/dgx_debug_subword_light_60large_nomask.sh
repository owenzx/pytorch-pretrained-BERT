...
allennlp train new_scripts/head/debug_subword_light60_large.jsonnet -s outputs/head_debug_subword_light60large_nomask --include-package new_allen_packages
