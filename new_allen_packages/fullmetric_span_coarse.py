...
# from .fullmetric_conll_coref_scores import FullMetricConllCorefScores as ConllCorefScores
...
@Model.register("coref_coarse_metric")
class CoreferenceResolver(Model):
    ...
    def __init__(
        ...
        vocab: Vocabulary,
        text_field_embedder: TextFieldEmbedder,
        # speaker_field_embedder: TextFieldEmbedder,
        # genre_field_embedder: TextFieldEmbedder,
        context_layer: Seq2SeqEncoder,
        mention_feedforward: FeedForward,
        antecedent_feedforward: FeedForward,
        feature_size: int,
        ...
        **kwargs
        ...
        # self._speaker_field_embedder = speaker_field_embedder
        # self._genre_field_embedder = genre_field_embedder
        ...
        #     input_dim=text_field_embedder.get_output_dim() + speaker_field_embedder.get_output_dim() + genre_field_embedder.get_output_dim()
        # )
        ...
        assert(self._coarse_to_fine is True)
    ...
    def forward(
        ...
        # speaker: TextFieldTensors,
        # genre: TextFieldTensors,
        ...
        # speaker_embeddings = self._speaker_field_embedder(speaker)
        # genre_embeddings = self._genre_field_embedder(genre)
        tmp = 0
        text_embeddings = self._lexical_dropout(self._text_field_embedder(text))

        # text_embeddings = torch.cat((text_embeddings, speaker_embeddings, genre_embeddings), -1)
