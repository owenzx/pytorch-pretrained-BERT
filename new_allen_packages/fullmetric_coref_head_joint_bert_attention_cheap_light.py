...
from .conll_head_coref_scores import FullMetricConllHeadPruneCorefScores as ConllHeadPruneCorefScores
...
@Model.register("coref_head_joint_bert_attention_cheap_light_metric")
