...
@Metric.register("fullmetric_conll_coref_scores")
class FullMetricConllCorefScores(Metric):
    ...
    def get_metric(self, reset: bool = False) -> Tuple[float, float, float]:
        ...
        muc_prec, muc_reca, muc_f1, b3_prec, b3_reca, b3_f1, ceaf_prec, ceaf_reca, ceaf_f1 = (metric(e) for e in self.scorers for metric in metrics)
        mean_f1 = (muc_f1 + b3_f1 + ceaf_f1) / 3
        if reset:
            self.reset()
        # return precision, recall, f1_score
        return muc_prec, muc_reca, muc_f1, b3_prec, b3_reca, b3_f1, ceaf_prec, ceaf_reca, ceaf_f1, mean_f1
