...
from .conll_head_coref_scores import ConllHeadPruneCorefScores, ConllHeadCorefScores
...
@Model.register("coref_head_joint_bert_prune")
class CoreferenceResolver(Model):
    ...
    def forward(
        ...
        # try:
        #     assert(all(original_antecedent_indices.flatten() == predicted_antecedents.flatten()))
        # except:
        #     print(original_antecedent_indices)
        #     print(predicted_antecedents)
        #     print("INDICES NOT EQUAL")
        #     exit()

        #original_antecedent_indices = predicted_antecedents
