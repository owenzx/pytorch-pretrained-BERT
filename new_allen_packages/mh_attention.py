...
class MHAttention(Module):
    ...
    Shape:
        ...
        if not self._qkv_same_embed_dim:
            return multi_head_attention_forward_w(
...
def multi_head_attention_forward_w(query,                           # type: Tensor
                                 key,                             # type: Tensor
                                 value,                           # type: Tensor
    ...
    #             multi_head_attention_forward_w, tens_ops, query, key, value,
    ...
    if need_weights:
        ...
        return attn_output, raw_attn_output_weights.sum(dim=1) / num_heads
    else:
