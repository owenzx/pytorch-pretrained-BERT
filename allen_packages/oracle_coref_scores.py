...
from utils import map_spans

@Metric.register("oracle_coref_scores")
class OracleCorefScores(Metric):
    ...
    def __call__(self,  # type: ignore
        ...
        for i, metadata in enumerate(metadata_list):
            ...
            oracle_predicted_clusters, mention_to_predicted = map_spans(predicted_clusters, gold_clusters)
            for scorer in self.scorers:
                scorer.update(oracle_predicted_clusters, gold_clusters, mention_to_predicted, mention_to_gold)
