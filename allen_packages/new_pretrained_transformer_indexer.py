...
from .new_pretrained_transformer_tokenizer import NewPretrainedTransformerTokenizer as PretrainedTransformerTokenizer
...
class NewPretrainedTransformerIndexer(TokenIndexer):
    """
    ...
    def __init__(
        self, model_name: str, namespace: str = "tags", max_length: int = None, token_min_padding_length: int = 0
    ) -> None:
    ...
    @overrides
    def tokens_to_indices(self, tokens: List[Token], vocabulary: Vocabulary, indexer_name: str) -> IndexedTokenList:
    ...
    def __eq__(self, other):
        if isinstance(other, NewPretrainedTransformerIndexer):
