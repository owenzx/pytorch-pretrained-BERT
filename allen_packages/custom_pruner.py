...
class Pruner(torch.nn.Module):
    ...
    def forward(self, # pylint: disable=arguments-differ
                ...
                fixed_selection_idx: Optional[torch.LongTensor] = None) -> Tuple[torch.FloatTensor, torch.LongTensor,
        ...
        if fixed_selection_idx is None:
            ...
            top_indices = fixed_selection_idx
