...
from allennlp.common.util import (dump_metrics, gpu_memory_mb, peak_memory_mb,
                                  lazy_groups_of, get_frozen_and_tunable_parameter_names)
...
@TrainerBase.register("lasy-trainer")
class LasyTrainer(TrainerBase):
    def __init__(self,
                 ...
                 optimizer_controller: Optional[torch.optim.Optimizer] = None,
    ...
    def _train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        for i, batch_group in enumerate(train_generator_tqdm):
            ...
            if  self._gradient_accumulation_normalization:
                ...
                loss_controller /= self._gradient_accumulation_steps
            ...
            if self._tensorboard.should_log_this_batch():
                ...
                if "reward" in output_dict.keys():
                    self._tensorboard.add_train_scalar("controller/reward", output_dict["reward"])
                if "controller_optim_loss" in output_dict.keys():
                    self._tensorboard.add_train_scalar("controller/controller_optim_loss", output_dict["controller_optim_loss"])
    ...
    def from_params(cls,   # type: ignore
        ...
        train_model = params.pop_bool("train_model", True)
        train_controller = params.pop_bool("train_controller", True)
        ...
        return cls(model, optimizer, iterator, dataset_reader, unlabel_path,
                   train_data, unlabeled_data, validation_data,optimizer_controller,
