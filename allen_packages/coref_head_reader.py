...
@DatasetReader.register("coref_head_only")
class ConllCorefReader(DatasetReader):
    ...
    def text_to_instance(
        ...
        head_labels = [0 for _ in flattened_sentences]
        for i in heads_idx:
            head_labels[i] = 1

        head_field = SequenceLabelField(head_labels, text_field)

        fields: Dict[str, Field] = {
            "text": text_field,
            "head_label": head_field,
