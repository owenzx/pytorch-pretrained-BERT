...
from .new_pretrained_transformer_indexer import NewPretrainedTransformerIndexer as PretrainedTransformerIndexer
...
class PretrainedTransformerMismatchedIndexer(TokenIndexer):
    ...
    def __init__(
        ...
        self._matched_indexer = PretrainedTransformerIndexer(
            model_name, namespace, max_length, token_min_padding_length
        )
